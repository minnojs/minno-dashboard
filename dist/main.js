(function () {
	...
	function controller$4(settings, defaultSettings, rows){
	...
	function controller$7(object, settings,stimuliList, startStimulusList ,index){
	    var element = settings[object.key];
	...
	function controller$8(object, settings, stimuliList, taskType){
	    var element = settings[object.key];
	    var fields = {
	        newStimulus : m.prop(''),
	        selectedStimuli: m.prop(''),
	...
	function controller$9(taskType, settings, elementName){
	...
	function view$5(ctrl, settings, defaultSettings, clearElement, taskType, currTab) {
	    return m('div', [
	        taskType === 'BIAT' ?
	            ...
	            : currTab.includes('StimulusCSS') ?
	                m.component(parametersComponent$1, taskType, settings, currTab)
	                : taskType === 'EP' || taskType === 'AMP' ?
	                    m.component(elementComponent$2, {key:currTab}, settings, defaultSettings[currTab].mediaArray, taskType)
	...
	function view$10(ctrl){
	    return viewImport(ctrl);
	}

	function controller$10(settings) {
	    return {handleFile: handleFile, updateSettings: updateSettings$1};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function() {
	            ...
	            settings = updateSettings$1(settings, fileContent);
	        };
	    }
	}
	function updateSettings$1(settings, input) {
	...
	var tabs = {
	    ...
	    'text': {text: 'Texts', component: textComponent$1, rowsDesc: textDesc},
	...
	function url$3(study_type, study_id, file_id) {
	    return (baseUrl + "/files/" + (encodeURIComponent(study_id)) + "/file/" + (encodeURIComponent(file_id)));
	}

	var save$1 = function (study_type, study_id, file_id, content, last_modify) { return fetchJson(url$3(study_type, study_id, file_id), {
	    method: 'put',
	    body: {content: JSON.stringify(content), last_modify: last_modify}
	}); };

	var saveToJS = function (study_type, study_id, file_id, content, last_modify) { return fetchJson(url$3(study_type, study_id, file_id), {
	    method: 'put',
	...
	function controller(ref, external){
	    ...
	    function do_save(){
	        ...
	        save$1('iat', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('iat', studyId, jsFileId, toString(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
	...
	function controller$12(settings, defaultSettings, rows){
	    var blocks = settings.blocks;
	...
	function view$12(ctrl, settings){
	    return m('.space' , [
	...
	function controller$13(settings, defaultSettings, clearElement){
	...
	function view$13(ctrl,settings) {
	    return m('.space',[
	        m('.row',[
	            m('.col-md-12',
	...
	function controller$14(settings, defaultSettings, blocksObject){
	    var error_msg = [];
	    ...
	    function createFile(settings, type){
	        return function(){
	            ...
	            if (type === 'JS'){
	                ...
	                output = updateSettings$2(settings);
	                textFileAsBlob = new Blob([JSON.stringify(output,null,4)], {type : 'application/json'});
	...
	function toString$1(settings, external){
	    return toScript$1(updateSettings$2(settings), external);
	}

	function updateSettings$2(settings){
	...
	function view$14(ctrl, settings){
	...
	function view$15(ctrl){
	    return viewImport(ctrl);
	}

	function controller$15(settings) {
	    return {handleFile: handleFile, updateSettings: updateSettings$3};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function(){
	            var fileContent = JSON.parse(reader.result);
	            settings = updateSettings$3(settings, fileContent);
	        };
	    }
	}
	function updateSettings$3(settings, input) {
	...
	var tabs$1 = {
	    'parameters': {text: 'General parameters', component: parametersComponent, rowsDesc: parametersDesc$1},
	    ...
	    'text': {text: 'Texts', component: textComponent$1, rowsDesc: textDesc$1},
	    'output': {text: 'Complete', component: outputComponent, rowsDesc: blocksDesc$1},
	...
	function controller$11(ref, external){
	    var file = ref.file;
	    var study = ref.study;
	    if ( external === void 0 ) external = false;
	    ...
	    function do_save(){
	        ...
	        var fileId = m.route.param('fileId');
	        var jsFileId =  fileId.split('.')[0]+'.js';
	        save$1('biat', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('biat', studyId, jsFileId, toString$1(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
	...
	function controller$17(settings, defaultSettings, blocksObject){
	    var error_msg = [];
	    ...
	    function createFile(settings, fileType){
	        return function(){
	            ...
	            if (fileType === 'JS') {
	                ...
	                output = updateSettings$4(settings);
	                textFileAsBlob = new Blob([JSON.stringify(output,null,4)], {type : 'application/json'});
	...
	function updateSettings$4(settings){
	    var output={
	...
	function toString$2(settings, external){
	    return toScript$2(updateSettings$4(settings), external);
	}
	...
	function view$17(ctrl, settings){
	...
	function view$18(ctrl){
	    return viewImport(ctrl);
	}

	function controller$18(settings){
	    var fileInput = m.prop('');
	    return {fileInput: fileInput, handleFile: handleFile, updateSettings: updateSettings$5};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function(){
	            var fileContent = JSON.parse(reader.result);
	            settings = updateSettings$5(settings, fileContent);
	        };
	    }
	}

	function updateSettings$5(settings, input){
	...
	var tabs$2 = {
	    'parameters': {text: 'General parameters', component: parametersComponent, rowsDesc: parametersDesc$2},
	    'blocks': {text: 'Blocks', component: blocksComponent, rowsDesc: blocksDesc$2},
	    'categories': {
	        text: 'Categories',
	        component: categoriesComponent,
	    ...
	    'text': {text: 'Texts', component: textComponent$1, rowsDesc: textDesc$2},
	    'output': {text: 'Complete', component: outputComponent$1, rowsDesc: blocksDesc$2},
	...
	function controller$16(ref, external){
	    var file = ref.file;
	    var study = ref.study;
	    if ( external === void 0 ) external = false;
	    ...
	    function do_save(){
	        ...
	        var fileId = m.route.param('fileId');
	        var jsFileId =  fileId.split('.')[0]+'.js';
	        save$1('spf', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('spf', studyId, jsFileId, toString$2(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
	...
	function controller$20(settings, defaultSettings, clearBlock){
	    var error_msg = [];
	    error_msg = validityCheck$3(error_msg, settings, clearBlock);
	    ...
	    function createFile(fileType){
	        return function(){
	            ...
	            if (fileType === 'JS') {
	                ...
	                output = updateSettings$6(settings);
	                textFileAsBlob = new Blob([JSON.stringify(output,null,4)], {type : 'application/json'});
	...
	function toString$3(settings, external){
	    return toScript$3(updateSettings$6(settings), external);
	}
	...
	function updateSettings$6(settings){
	...
	function validityCheck$3(error_msg, settings, clearBlock){
	...
	function view$20(ctrl, settings){
	...
	function controller$21(settings, defaultSettings, rows){
	...
	function view$22(ctrl){
	    return viewImport(ctrl);
	}

	function controller$22(settings) {
	    return {handleFile: handleFile, updateSettings: updateSettings$7};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function() {
	            var fileContent = JSON.parse(reader.result);
	            settings = updateSettings$7(settings, fileContent);
	        };
	    }
	}
	...
	function updateSettings$7(settings, input) {
	...
	var tabs$3 = {
	    'parameters': {text: 'General parameters', component: parametersComponent, rowsDesc: parametersDesc$3},
	    'blocks': {text: 'Blocks', component: blocksComponent$1, rowsDesc: blocksDesc$3},
	    'category': {text: 'Category', component: categoriesComponent, rowsDesc: categoryClear$2, subTabs: category},
	    'attributes': {
	        text: 'Attributes',
	        component: categoriesComponent,
	    ...
	    'text': {text: 'Texts', component: textComponent$1, rowsDesc: textDesc$3},
	    'output': {text: 'Complete', component: outputComponent$2, rowsDesc: blocksDesc$3.slice(-1)[0]},
	...
	function controller$19(ref, external){
	    var file = ref.file;
	    var study = ref.study;
	    if ( external === void 0 ) external = false;
	    ...
	    function do_save(){
	        ...
	        var fileId = m.route.param('fileId');
	        var jsFileId =  fileId.split('.')[0]+'.js';
	        save$1('stiat', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('stiat', studyId, jsFileId, toString$3(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
	...
	function controller$24(settings){
	    var error_msg = [];
	    error_msg = validityCheck$4(error_msg, settings);
	    ...
	    function createFile(fileType){
	        return function(){
	            ...
	            if (fileType === 'JS'){
	                ...
	                output = updateSettings$8(settings);
	                textFileAsBlob = new Blob([JSON.stringify(output,null,4)], {type : 'application/json'});
	...
	function validityCheck$4(error_msg, settings){
	...
	function toString$4(settings, external){
	    return toScript$4(updateSettings$8(settings), external);
	}
	...
	function updateSettings$8(settings){
	...
	function view$24(ctrl, settings){
	...
	function view$25(ctrl){
	    return viewImport(ctrl);
	}

	function controller$25(settings) {
	    var fileInput = m.prop('');
	    return {fileInput: fileInput, handleFile: handleFile, updateSettings: updateSettings$9};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function() {
	            var fileContent = JSON.parse(reader.result);
	            updateSettings$9(settings, fileContent);
	        };
	    }
	}
	...
	function updateSettings$9(settings, input) {
	...
	var tabs$4 = {
	    'parameters': {text: 'General parameters', component: parametersComponent, rowsDesc: parametersDesc$4},
	    'blocks': {text: 'Blocks', component: blocksComponent, rowsDesc: blocksDesc$4},
	    'prime': {
	    ...
	    'text': {text: 'Texts', component: textComponent$1, rowsDesc: textDesc$4},
	    'output': {text: 'Complete', component: outputComponent$3},
	...
	function controller$23(ref, external){
	    var file = ref.file;
	    var study = ref.study;
	    if ( external === void 0 ) external = false;
	    ...
	    function show_do_save(){
	        var error_msg = [];
	        error_msg = validityCheck$4(error_msg, ctrl.settings);
	        if(error_msg.length !== 0) {
	            return messages.confirm({
	                header: 'Some problems were found in your script, it\'s recommended to fix them before saving:',
	                content:
	    ...
	    function do_save(){
	        ...
	        var fileId = m.route.param('fileId');
	        var jsFileId =  fileId.split('.')[0]+'.js';
	        save$1('ep', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('ep', studyId, jsFileId, toString$4(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
	...
	function controller$27(settings, defaultSettings, blocksObject){
	    var error_msg = [];
	    ...
	    function createFile(settings, fileType){
	        return function(){
	            ...
	            if (fileType === 'JS') {
	                ...
	                output = updateSettings$10(settings);
	                textFileAsBlob = new Blob([JSON.stringify(output,null,4)], {type : 'application/json'});
	...
	function validityCheck$5(error_msg, settings){
	    //Parameters Tab
	    var textParameters= {
	...
	function toString$5(settings, external){
	    return toScript$5(updateSettings$10(settings), external);
	}
	...
	function updateSettings$10(settings){
	...
	function view$27(ctrl,settings){
	...
	function controller$28(settings, defaultSettings, exampleParameters){
	...
	function controller$29(settings, defaultSettings, rows){
	    var blocks = settings.blocks;
	...
	function view$30(ctrl){
	    return viewImport(ctrl);
	}

	function controller$30(settings) {
	    return {handleFile: handleFile, updateSettings: updateSettings$11};
	    ...
	    function handleFile(){
	        ...
	        reader.onload = function(){
	            var fileContent = JSON.parse(reader.result);
	            settings = updateSettings$11(settings, fileContent);
	        };
	    }
	}
	...
	function updateSettings$11(settings, input) {
	...
	var tabs$5 = {
	    'parameters':{text: 'General parameters', component: parametersComponent, rowsDesc: parametersDesc$5 },
	    'blocks':{text: 'Blocks', component: blocksComponent$2, rowsDesc: blocksDesc$5},
	    ...
	    'text':{text: 'Texts', component: textComponent$1, rowsDesc: textDesc$5},
	...
	function controller$26(ref, external){
	    var file = ref.file;
	    var study = ref.study;
	    if ( external === void 0 ) external = false;
	    ...
	    function do_save(){
	        ...
	        var fileId = m.route.param('fileId');
	        var jsFileId =  fileId.split('.')[0]+'.js';
	        save$1('amp', studyId, fileId, ctrl.settings, ctrl.last_modify)
	            .then (function () { return saveToJS('amp', studyId, jsFileId, toString$5(ctrl.settings, ctrl.external), ctrl.last_modify); })
	            .then(ctrl.study.get())
